...
class Trainer(object):
    ...
    def iterate(self, epoch, phase):
        ...
        best_threshold = meter.get_best_thresholds()
        epoch_loss = (running_loss * accu_steps) / total_batches
        epoch_log(self.log, self.tb, phase, epoch, epoch_loss, meter, start)
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.num_epochs + 1):
            ...
            #)
            if "new_val" in self.cfg['phases']:
                self.iterate(epoch, "new_val")
