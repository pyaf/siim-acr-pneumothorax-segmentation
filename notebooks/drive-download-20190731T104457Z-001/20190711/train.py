...
def do_valid(net, valid_loader):
    ...
    valid_dice_neg = 0
    valid_dice_pos = 0
    for b, (input, truth, num_component, infor) in enumerate(valid_loader):
...
def run_train():
    ...
    out_dir = \
        '/root/share/project/kaggle/2019/chest/delivery/20190710/results/deeplab3plus-02-256x256'
    ...
    while iter < num_iters:
        ...
        optimizer.zero_grad()
        for input, truth, num_component, infor in train_loader:
